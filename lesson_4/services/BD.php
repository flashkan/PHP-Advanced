...
class BD implements IBD
{
    ...
    /**
     * Возвращает объект с соответствующем id из базы данных.
     * @param string $sql Запрос в БД.
     * @param string $class Класс от которого создается объект.
    ...
    /**
     * Возвращает массив с объектами из базы данных.
     * @param string $sql Запрос в БД.
     * @param string $class Класс от которого создается объект.
     * @param array $params Массив с параметрами.
     * @return mixed
